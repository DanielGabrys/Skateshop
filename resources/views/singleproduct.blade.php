                            ...
                            <div class="col-md-5 col-sm-6 summary-before ">
                                ...
                                <div class="product-slider product-shop">
                                    ...
                                    <ul class="slides">
                                        ...
                                        <li data-thumb="{{Storage::disk('local')->url('product_images/'.$image['image'])}}" width="100" height="100">
                                            <a href="{{Storage::disk('local')->url('product_images/'.$image['image'])}}" width="100" height="100" data-imagelightbox="gallery" class="hoodie_7_front">
                                                <img src="{{Storage::disk('local')->url('product_images/'.$image['image'])}}" width="400" height="400" class="attachment-shop_single" alt="image">
                                            </a>
                                        </li>
                                        @endforeach
                                    </ul>
